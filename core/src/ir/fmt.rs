...
//         .params
//         .iter()
//         .map(|param_id| format!("{} %{}", self[param_id].ir_type, counter()))
//         .collect::<Vec<_>>()
//         .join(", "),
//     )?;
//     if func.is_definition() {
...
//               .iter()
//               .map(|inst_id| {
//                 match &self[inst_id].value.as_instruction_unchecked() {
