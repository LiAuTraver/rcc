use ::rcc_serialize::Palette;
use ::std::fmt;

use crate::{DumpSpan, Dumpable, Dumper, types::*};
...
mod statement {
  ...
  pub type Return<'c, E> = crate::blueprints::RawReturn<E>;
  pub type If<'c, S, E> = crate::blueprints::RawIf<S, E>;
  pub type While<'c, S, E> = crate::blueprints::RawWhile<S, E>;
  pub type DoWhile<'c, S, E> = crate::blueprints::RawDoWhile<S, E>;
  pub type For<'c, S, E> = crate::blueprints::RawFor<S, E>;
  pub type Switch<'c, S, E, C> = crate::blueprints::RawSwitch<S, E, C>;
  pub type Case<'c, S, C> = crate::blueprints::RawCase<S, C>;
  pub type Default<'c, S> = crate::blueprints::RawDefault<S>;
  pub type Label<'c, S> = crate::blueprints::RawLabel<'c, S>;
  pub type Goto<'c> = crate::blueprints::RawGoto<'c>;
  pub type Compound<'c, S> = crate::blueprints::RawCompound<S>;
